...
// Since, we are not directly using 'chromedriver', so do not store it in a variable
// const chrome = require("selenium-webdriver/chrome"); // For headless browser
const wd = require("selenium-webdriver");

// const browser = new wd.Builder().forBrowser("chrome").setChromeOptions(new chrome.Options().headless()).build(); // setChromeOptions is for headless browser.
